...
const hero = document.getElementById("rent");
...
gridBtn.addEventListener("click", () => {
  ...
  // Hide FAQ and blog section in grid view
...
listBtn.addEventListener("click", () => {
  ...
  // Show FAQ and blog section in list view
...
gridView.addEventListener("click", () => {
  blogSection.style.display = "none"; // hide in grid view
});

listView.addEventListener("click", () => {
  blogSection.style.display = "block"; // show in list view
});
